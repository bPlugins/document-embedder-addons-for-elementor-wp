...
final class BPlugins_Controls_Register {
	...
	public function admin_notice_missing_main_plugin() {
		...
		/* translators: 1: Plugin name 2: Elementor */
			esc_html__( '"%1$s" requires "%2$s" to be installed and activated.', 'document-embedder-addons-for-elementor' ),
			'<strong>' . esc_html__( 'Protected Content', 'document-embedder-addons-for-elementor' ) . '</strong>',
