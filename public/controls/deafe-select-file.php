	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				<a href="#" class="tnc-b-select-file elementor-button elementor-button-default elementor-button-go-pro" style="padding: 10px 15px; display: block;text-align: center;" id="select-file-<?php echo esc_attr( $control_uid ); ?>" ><?php echo esc_html__( '{{data.label}}', 'document-embedder-addons-for-elementor' ); ?></a> <br />
